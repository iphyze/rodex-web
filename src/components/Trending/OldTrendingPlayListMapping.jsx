...
//           const isSongLoading = isLoading[song._id]; // Assuming isLoading is now an object with song._id as keys
...
//               </div>
//               {/* <div className={`fas ${!songLengths[song._id] || isBuffering ? 'fa-spinner fa-spin' : isActiveSong ? 'fa-pause' : 'fa-play'} playlist-play-btn ${isActiveSong ? 'active-pbtn-text' : ''}`} onClick={() => handleSongClick(song)}></div> */}
